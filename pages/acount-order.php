               ...
               <div class="section" id="list-product-wp">
                    ...
                    <div class="section-detail">
                         ...
                         <form action="">
                              ...
                              <input value="<?= $row['user_name'] ?>" class="ip-style" type="text" id="fname" name="user_name" readonly>

                              <label for="lname">Số điện thoại</label>
                              <input value="<?= $row['user_phone'] ?>" class="ip-style" type="text" id="lname" name="user_phone" readonly>

                              <label for="lname">Địa chỉ</label>
                              <input value="<?= $row['user_address'] ?>" class="ip-style" type="text" id="lname" name="user_phone" readonly>
                              <?php } ?>
                    ...
                    <table>
                         ...
                         <tr>
                              ...
                              <td><?= number_format($row2['total_money']) ?></td>
                              <td><?= $statusText ?></td>
                              <td><a href="?page=acount-detail-order&order_id=<?= $row2['order_id'] ?>">Chi tiết</a></td>
                         </tr>
                         <?php } ?>
                    </table>
               </div>
