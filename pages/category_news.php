                         ...
                         <ul class="list-item">
                              <li class="clearfix">
                                   ...
                                   <div class="info fl-right">
                                        <a href="?page=detail_news" title="" class="title">Hướng dẫn nuôi dạy trẻ khoa
                                             học</a>
                                        <span class="create-date">29/12/2016</span>
                                        <p class="desc">Lorem Ipsum chỉ đơn giản là một đoạn văn bản giả, được dùng vào
                                             việc trình bày và dàn trang phục vụ cho in ấn. Lorem Ipsum đã được sử dụng
                    ...
                    <div class="section-detail">
                         <ul class="list-item">
                              <li class="clearfix">
                                   ...
                                   <div class="info fl-right">
                                        <a href="?page=detail_product" title="" class="product-name">Bio-Lashes Serum
                                             dưỡng dài lông mi và lông mày</a>
                                        <div class="price-wp">
