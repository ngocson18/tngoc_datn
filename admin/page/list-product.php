               ...
               <div class="actions">
                    <form method="GET" action="" class="form-actions">
                         ...
                         <select id="price" name="actions">
                              ...
                              <option value="0">Nhỏ hơn 10.000</option>
                              <option value="1">Từ 10.000 - 50.000</option>
                              <option value="2">Lớn hơn 50.000</option>
                              ?>
                         </select>
                              ...
                              <table class="table list-table-wp table-bordered">
                                   ...
                                   <tbody id="tbody">
                                        ...
                                        <tr>
                                             ...
                                             <td><span class="tbody-text">
                                                       <?php
                                                                 echo "<div><img src=$img_src style='width:300px; height: 200px;'></div>";
                                                                 ?>
                                             </td>
                                             <td class="tbody-text">
