     ...
     <div id="foot-body">
          <div class="wp-inner clearfix">
               <div class="block" id="info-company">
                    <h3 class="title">BEPCUANGOC</h3>
                    <p class="desc">BEPCUANGOC luôn cung cấp những món ăn ngon và đảm bảo chất lượng đến tay người tiêu
                         dùng.</p>
                    <div id="payment">
                         <div class="thumb">
               ...
               <div class="block menu-ft" id="info-shop">
                    ...
                    <ul class="list-item">
                         ...
                         <li>
                              <p>0968876944 - 0865971861</p>
                         </li>
                         <li>
                              <p>t.ngoc1519@gmail.com</p>
                         </li>
                    </ul>
               </div>
